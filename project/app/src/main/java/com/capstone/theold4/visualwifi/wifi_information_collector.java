...
public class wifi_information_collector extends Service implements LocationListener {
            ...
            try {
                ...
                for (ScanResult scanresult : mScanResult) {
                    try {
                        ...
                        lat = Math.round(lat*100000) /100000.0;
                        lng = Math.round(lng*100000) /100000.0;
    ...
    public void onCreate() {
        super.onCreate();
        Log.i("[INFORMATION_COLLECTOR]", "start collecting");
        // 와이파이 관련 변수들
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.i("[INFORMATION_COLLECTOR]", "end collecting");
        try {
